...
from torch.utils.data import DataLoader, SequentialSampler, TensorDataset, dataloader
...
# tokenizer = AutoTokenizer.from_pretrained(f"{base_dir}/HuggingFace/gpt2")
...
tokenizer = GPT2Tokenizer.from_pretrained(f"{base_dir}/HuggingFace/gpt2", do_lower_case=True)
...
model_paths = [
    # "/home/oai/efficient-nlp/outputs/distilgpt2/FineTune_bsz_lr_epoch10_CoLA/checkpoint-399",
    "/home/oai/efficient-nlp/outputs/distilgpt2/FineTune_bsz_lr_epoch10_CoLA/checkpoint-1206/",
    "/home/oai/efficient-nlp/outputs/gpt2/FineTune_bsz_lr_epoch4_CoLA/checkpoint-532",
]
...
for key in model_keys:
    ...
    models[key].eval()
    models[key].resize_token_embeddings(len(tokenizer))
    models[key].config.pad_token_id = -100
    # print(key, models[key])
    # models[key].config.num_labels = 2
# exit()
# -------------  Dataset Prepare --------------
